...
export function CompactCurrencySelector({
  ...
  if (isLoading) {
    return (
      <div className="relative">
        <Button
          variant="outline"
          className="w-full justify-between px-3 py-2 h-10 bg-white border-gray-300 text-gray-500"
          disabled
        >
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <Button
        variant="outline"
        className="w-full justify-between px-3 py-2 h-10 bg-white border-gray-300 hover:bg-gray-50"
        ...
        <span className="flex items-center gap-2">
          {selectedCurrencyData ? (
            <>
              ...
              <span className="text-gray-600">{selectedCurrencyData.code}</span>
            </>
          ) : (
